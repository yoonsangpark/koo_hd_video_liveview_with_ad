MODULE_NAME = koo_hd_video_liveview_with_ad
# DIRs
VOS_DRIVER_DIR = $(NVT_VOS_DIR)/drivers
HDAL_TEST_CASES_DIR = $(NVT_HDAL_DIR)/test_cases
RTOS_OUTPUT_DIR = $(HDAL_TEST_CASES_DIR)/output
# INCs
...
SRC = koo_video_liveview_with_ad.c
...
cp:
	cp -f hd_video_liveview_with_ad /mnt/nfs/gchwang/529
###############################################################################
# rtos Makefile                                                               #
###############################################################################
